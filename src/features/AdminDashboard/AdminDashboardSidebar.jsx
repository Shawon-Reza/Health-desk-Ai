                ...
                {menuItems.map((item) => {
                    ...
                    return (
                        <NavLink
                            ...
                            onClick={onClick}
                            className={({ isActive }) =>
                                `w-full flex items-center gap-3 px-4 py-3 rounded-lg text-2xl text-gray-600 text-default opacity-90 transform transition-all duration-200 ease-in-out ${
                                    isActive ? " bg-white/35" : "hover:border hover:border-[#E2E2E2] "
                                }`
                            }
                        >
                            <Icon size={21} />
